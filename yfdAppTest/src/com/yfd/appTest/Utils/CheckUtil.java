...
public class CheckUtil {
	...
	public static final Pattern MOBILE_NUMBER_PATTERN = Pattern
			.compile("^(0|86|17951)?(10648|10649|13[0-9]|15[012356789]|17[0-9]|18[0-9]|14[57])[0-9]{8}$");
	/**
	 * 手机号码Pattern
	 */
	public static final Pattern MOBILE_NUMBER = Pattern
			.compile("^(10648|10649)?[0-9]{8}$");
	...
	public static boolean isMobile(String s) {
		Matcher m = MOBILE_NUMBER.matcher(s);
//		Matcher m = MOBILE_NUMBER_PATTERN.matcher(s);
		return m.matches();
	}
	/**
