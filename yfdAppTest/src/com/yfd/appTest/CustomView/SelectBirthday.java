...
import com.yfd.appTest.widget.NumericWheelAdapter;
import com.yfd.appTest.widget.OnWheelChangedListener;
import com.yfd.appTest.widget.WheelView;
...
public class SelectBirthday extends PopupWindow  {
	...
	public SelectBirthday(Activity context,final TextView txt) {
		super(context);
		mContext = context;
		this.age =Utils.getlocalSysDate() ;
