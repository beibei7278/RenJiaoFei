...
public class BaseActivity extends Activity{
	...
	public static Dialog createLoadingDialog(Context context, String msg) {
	  ...
	  public  void initPopWindow(final List<String> list,final Button button){  
	        ...
	        View contentView = LayoutInflater.from(getApplicationContext()).inflate(R.layout.popwindowlist, null);  
	  ...
	  public class adapter extends BaseAdapter{
		...
		public View getView(int arg0, View view, ViewGroup arg2) {
			...
			if(view==null){
				...
				vh=new ViewHolder();
				view=LayoutInflater.from(getApplicationContext()).inflate(R.layout.poplist_item, null);
