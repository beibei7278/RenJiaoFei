...
public class MipcaActivityCapture extends Activity implements Callback{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		back=(ImageView)findViewById(R.id.saoma_back);
...
//		Intent resultIntent = new Intent(MipcaActivityCapture.this,PhkkActivity.class);
//		resultIntent.putExtra("result", resultString);
//		resultIntent.putExtra("code", resultString);
//		resultIntent.putExtra("token", token);
//		resultIntent.putExtra("paramid", paramid);
//		startActivity(resultIntent);
		BaseApplication.Saoma=resultString;
		finish();
	}
