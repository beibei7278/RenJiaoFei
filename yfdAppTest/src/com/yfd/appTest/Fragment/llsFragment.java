...
public class llsFragment extends Basefragment {
			...
			if(msg.obj!=null){
				...
				if(msg.obj!=null){
					...
					if(lists.size()>0){
						...
						adapter=new HLSearchkkAdapter(lists, con,1);
 ...
 private Button save;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
			...
			Mview=LayoutInflater.from(getActivity()).inflate(R.layout.fragment_llsearch, null);
			
			ddtxt=(EditText)Mview.findViewById(R.id.search_namell);
			txtshow=(ListView)Mview.findViewById(R.id.lls_txt);
			save=(Button)Mview.findViewById(R.id.search_llsavebtn);
			con=getActivity();
			save.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					AnsyPost.getArrylistpost(BaseApplication.searchLL_URL+"?mobilenumber="+ddtxt.getText().toString()+"&pageNo=1&pageSize=1000", handler);
					
//					System.out.println(BaseApplication.searchLL_URL+"?mobilenumber="+ddtxt.getText().toString()+"&pageNo=1&pageSize=1000");
				}
			});
