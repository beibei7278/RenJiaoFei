 ...
 *
 */
public class ShopCartPullRefreshView extends LinearLayout {
	...
	private final static String REFRESH_RELEASE_TEXT = "松手加载更多";
	private final static String REFRESH_DOWN_TEXT = "下拉刷新";
	private final static float MIN_MOVE_DISTANCE = 30.0f;// 最小移动距离，用于判断是否在下拉，设置为0则touch事件的判断会过于平凡。具体值可以根据自己来设定
...
//	private ImageView refreshIndicatorView;
	...
	public ShopCartPullRefreshView(Context context) {
		super(context);
		mContext = context;
	}

	public ShopCartPullRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		init();
	}
	...
	private void init() {
		...
		refreshView = LayoutInflater.from(mContext).inflate(
				R.layout.refresh_top_shopcart, null);
//		// 指示器view
