...
//
//public class SchoolOrderManagerFragment extends Fragment implements
//		OnClickListener {
//	private TextView tv_main_text;
//	private WebView mWebView = null;
//	SchoolOrderListener mCallback;
...
//								URLInterface.SCHOOL_LOGIN_ORDER_MANAGER_CLASS)) {
//							Intent goRetail = new Intent();
//							goRetail.setClass(getActivity(),
//									TestOrderByClassActivity.class);
//							goRetail.putExtra("url", url);
//							view.loadUrl(null);
//							getActivity().startActivity(goRetail);
//						} else if (IsContainString
//								.containsString(
//										url,
//										URLInterface.SCHOOL_LOGIN_ORDER_MANAGER_DAI_ZHIFU)) {
//							Intent goRetail = new Intent();
//							goRetail.setClass(getActivity(),
//									TestOrderDaiZhiFuActivity.class);
//							goRetail.putExtra("url", url);
//							view.loadUrl(null);
//							getActivity().startActivity(goRetail);
//						} else if (IsContainString.containsString(url,
//								URLInterface.SCHOOL_LOGIN_ORDER_MANAGER_NO_BUY)) {
//							Intent goRetail = new Intent();
//							goRetail.setClass(getActivity(),
//									TestOrderNoBuyActivity.class);
//							goRetail.putExtra("url", url);
//							view.loadUrl(null);
//							getActivity().startActivity(goRetail);
//						} else {
...
//		tv_main_text.setText(getString(R.string.my_order_manager_title));
//		relNoNetWork.setVisibility(View.GONE);
...
//	}
//
//	public interface SchoolOrderListener {
...
//
//		try {
//			mCallback = (SchoolOrderListener) activity;
...
//			mWebView.loadUrl(URLInterface.SCHOOL_LOGIN_ORDER_MANAGER
