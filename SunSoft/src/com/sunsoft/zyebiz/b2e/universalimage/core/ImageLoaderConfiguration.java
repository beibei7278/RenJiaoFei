 ...
 *******************************************************************************/
package com.sunsoft.zyebiz.b2e.universalimage.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;
import com.sunsoft.zyebiz.b2e.universalimage.cache.disc.DiskCache;
import com.sunsoft.zyebiz.b2e.universalimage.cache.disc.naming.FileNameGenerator;
import com.sunsoft.zyebiz.b2e.universalimage.cache.memory.MemoryCache;
import com.sunsoft.zyebiz.b2e.universalimage.cache.memory.impl.FuzzyKeyMemoryCache;
import com.sunsoft.zyebiz.b2e.universalimage.core.assist.FlushedInputStream;
import com.sunsoft.zyebiz.b2e.universalimage.core.assist.ImageSize;
import com.sunsoft.zyebiz.b2e.universalimage.core.assist.QueueProcessingType;
import com.sunsoft.zyebiz.b2e.universalimage.core.decode.ImageDecoder;
import com.sunsoft.zyebiz.b2e.universalimage.core.download.ImageDownloader;
import com.sunsoft.zyebiz.b2e.universalimage.core.process.BitmapProcessor;
import com.sunsoft.zyebiz.b2e.universalimage.utils.L;
import com.sunsoft.zyebiz.b2e.universalimage.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.bufeng.medicaltreatment.universalimage.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.bufeng.medicaltreatment.universalimage.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.bufeng.medicaltreatment.universalimage.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.bufeng.medicaltreatment.universalimage.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.bufeng.medicaltreatment.universalimage.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.bufeng.medicaltreatment.universalimage.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.bufeng.medicaltreatment.universalimage.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.bufeng.medicaltreatment.universalimage.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.bufeng.medicaltreatment.universalimage.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.bufeng.medicaltreatment.universalimage.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.bufeng.medicaltreatment.universalimage.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.bufeng.medicaltreatment.universalimage.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.bufeng.medicaltreatment.universalimage.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.bufeng.medicaltreatment.universalimage.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
