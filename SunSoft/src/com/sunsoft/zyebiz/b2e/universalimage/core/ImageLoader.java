...
import com.sunsoft.zyebiz.b2e.universalimage.core.assist.FailReason;
...
import com.sunsoft.zyebiz.b2e.universalimage.core.assist.LoadedFrom;
import com.sunsoft.zyebiz.b2e.universalimage.core.assist.ViewScaleType;
import com.sunsoft.zyebiz.b2e.universalimage.core.imageaware.ImageAware;
import com.sunsoft.zyebiz.b2e.universalimage.core.imageaware.ImageViewAware;
import com.sunsoft.zyebiz.b2e.universalimage.core.imageaware.NonViewAware;
import com.sunsoft.zyebiz.b2e.universalimage.core.listener.ImageLoadingListener;
import com.sunsoft.zyebiz.b2e.universalimage.core.listener.ImageLoadingProgressListener;
import com.sunsoft.zyebiz.b2e.universalimage.core.listener.SimpleImageLoadingListener;
import com.sunsoft.zyebiz.b2e.universalimage.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain com.bufeng.medicaltreatment.universalimage.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.bufeng.medicaltreatment.universalimage.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.bufeng.medicaltreatment.universalimage.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.bufeng.medicaltreatment.universalimage.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.bufeng.medicaltreatment.universalimage.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	 ...
	 */
	public void displayZoomImage(String uri, ImageAware imageAware, DisplayImageOptions options,
			ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
		checkConfiguration();
		if (imageAware == null) {
			throw new IllegalArgumentException(ERROR_WRONG_ARGUMENTS);
		...
		ImageSize targetSize =new ImageSize(130, 150);
//		ImageSize targetSize = ImageSizeUtils.defineTargetSizeForView(imageAware, configuration.getMaxImageSize());
		String memoryCacheKey = MemoryCacheUtils.generateKey(uri, targetSize);
		engine.prepareDisplayTaskFor(imageAware, memoryCacheKey);
	 ...
	 * @param options
	 */
	public void displayZoomImage(String uri, ImageView imageView, DisplayImageOptions options) {
		displayZoomImage(uri, new ImageViewAware(imageView), options, null, null);
	}
	 ...
	 * {@link com.bufeng.medicaltreatment.universalimage.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.bufeng.medicaltreatment.universalimage.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.bufeng.medicaltreatment.universalimage.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.bufeng.medicaltreatment.universalimage.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
