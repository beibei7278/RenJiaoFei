...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.bufeng.medicaltreatment.universalimage.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
