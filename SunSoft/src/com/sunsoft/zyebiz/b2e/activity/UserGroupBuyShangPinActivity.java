...
//
//public class UserGroupBuyShangPinActivity extends Activity implements
//		OnClickListener {
...
//		NetManager.isHaveNetWork(UserGroupBuyShangPinActivity.this);
//		initView();
//		initDate();
//
//		showWebView();
...
//		tvMainText.setText(getString(R.string.group_buy_shangpin_title_main));
...
//					.isNetworkAvailable(UserGroupBuyShangPinActivity.this)) {
