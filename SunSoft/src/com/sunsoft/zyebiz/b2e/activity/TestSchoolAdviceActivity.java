...
//
//public class TestSchoolAdviceActivity extends Activity implements OnClickListener {
...
//		NetManager.isHaveNetWork(TestSchoolAdviceActivity.this);
//		initView();
//		initDate();
//
//		showWebView();
...
//			if (NetworkConnection.isNetworkAvailable(TestSchoolAdviceActivity.this)) {
...
//			}
//			mWebView.loadUrl(URLInterface.SCHOOL_LOGIN_MY_GARDEN_ADVICE
