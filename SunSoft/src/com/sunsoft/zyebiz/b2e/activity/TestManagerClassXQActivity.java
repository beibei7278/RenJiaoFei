...
//
//public class TestManagerClassXQActivity extends Activity implements
//		OnClickListener {
...
//		NetManager.isHaveNetWork(TestManagerClassXQActivity.this);
//		initView();
//		initDate();
//
//		showWebView();
...
//		tvMainText.setText(getString(R.string.class_xq));
//		Bundle bundle = this.getIntent().getExtras();
//		if (EmptyUtil.isNotEmpty(bundle)) {
//			url = bundle.getString("url");
//		} else {
//			url = URLInterface.SCHOOL_LOGIN_SCHOOL_MANAGER_CLASS_XQ;
//		}
//
//	}
//
...
//					.isNetworkAvailable(TestManagerClassXQActivity.this)) {
