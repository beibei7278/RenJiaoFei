...
//import com.sunsoft.zyebiz.b2e.fragment.EducationConsultationFragment;
//import com.sunsoft.zyebiz.b2e.fragment.EducationMyGardenFragment;
//import com.sunsoft.zyebiz.b2e.fragment.EducationSchoolManagerFragment;
...
//
//public class TestEducationMainActivity extends FragmentActivity implements
//		OnCheckedChangeListener {
//	private RadioGroup bottom_rg;
//	private RadioButton consultation,shoping, myGarden;
//	public static TestEducationMainActivity mainActivity;
...
//	private static final String saveFileName = APKCachePath + "sunsoft.apk";
//	public static String downUrl;
//	
//	public static boolean loadUrl = true;
//	private  String isUpdate;
//
//	@Override
//	protected void onCreate(Bundle savedInstanceState) {
//		super.onCreate(savedInstanceState);
//		setContentView(R.layout.activity_main_ji);
//		statrDataSumber();
//		ECApplication.getInstance().addActivity(TestEducationMainActivity.this);
//		mainActivity = this;
//
//		initView();
//		initDate();
...
//		SharedPreference.getUserInfo(TestEducationMainActivity.mainActivity);
//		changeFragment(new EducationConsultationFragment());
...
//			changeFragment(new EducationSchoolManagerFragment());
//
//		} else if (myGarden.getId() == checkedId) {
//			changeFragment(new EducationMyGardenFragment());
//
//		}
//
//	}
...
//                Toast.makeText(TestEducationMainActivity.mainActivity,getString(R.string.dialog_chengxu_exit), Toast.LENGTH_SHORT).show();
...
//		builder.setTitle(TestEducationMainActivity.mainActivity
//				.getString(R.string.dialog_login_title));
//		builder.setPositiveButton(TestEducationMainActivity.mainActivity
...
//				TestEducationMainActivity.mainActivity.getString(R.string.dialog_login_ok),
...
//				TestEducationMainActivity.mainActivity.getString(R.string.update_ok),
//				new DialogInterface.OnClickListener() {
//					public void onClick(DialogInterface dialog, int which) {
//						dialog.dismiss();
//						 update();
...
//				});
//
//		builder.setNegativeButton(TestEducationMainActivity.mainActivity.getString(R.string.update_cancle),
//				new android.content.DialogInterface.OnClickListener() {
//					public void onClick(DialogInterface dialog, int which) {
...
//		params.put("type", Constants.LOGIN_JIAOYUJU);
...
//								String versionCode = bodyResult.getVersionCode();
...
//				if (currentProgress < Constants.CONSTANT_ONE_HUNDRED) {
//
//				}
//				break;
//			case DOWN_OVER:
...
//		PackageInfo packInfo = packageManager.getPackageInfo(getPackageName(),Constants.CONSTANT_ZERO);
//		return packInfo.versionName;
//
//	}
//
//	public void update() {
//		Intent intentDownload = new Intent(TestEducationMainActivity.mainActivity, DownloadApkService.class);
//		bindService(intentDownload, conn, TestEducationMainActivity.mainActivity.BIND_AUTO_CREATE);
//	}
//
...
//					} catch (Exception e) {
//						Toast.makeText(TestEducationMainActivity.mainActivity, getString(R.string.no_sd_no_upload),
...
//		TestEducationMainActivity.mainActivity.startActivity(i);
//
//	}
//
