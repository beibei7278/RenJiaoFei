...
//
//public class TestOrderByClassXQActivity extends Activity implements
//		OnClickListener {
...
//		NetManager.isHaveNetWork(TestOrderByClassXQActivity.this);
//		initView();
//		initDate();
//
//		showWebView();
...
//		tvMainText.setText(getString(R.string.order_xq));
//		Bundle bundle = this.getIntent().getExtras();
//		if (EmptyUtil.isNotEmpty(bundle)) {
//			url = bundle.getString("url");
//		} else {
//			url = URLInterface.SCHOOL_LOGIN_ORDER_MANAGER_CLASS_XQ;
//		}
//
//	}
//
...
//							goRetail.setClass(
//									TestOrderByClassXQActivity.this,
...
//					.isNetworkAvailable(TestOrderByClassXQActivity.this)) {
