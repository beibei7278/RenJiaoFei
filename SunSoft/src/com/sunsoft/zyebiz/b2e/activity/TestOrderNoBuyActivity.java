...
//
//public class TestOrderNoBuyActivity extends Activity implements
//		OnClickListener {
//	/** ���� */
...
//		NetManager.isHaveNetWork(TestOrderNoBuyActivity.this);
//		initView();
//		initDate();
//
//		showWebView();
...
//		tvMainText.setText(getString(R.string.no_buy_student_list));
//		Bundle bundle = this.getIntent().getExtras();
//		if (EmptyUtil.isNotEmpty(bundle)) {
//			url = bundle.getString("url");
//		} else {
//			url = URLInterface.SCHOOL_LOGIN_ORDER_MANAGER_NO_BUY;
//		}
//
//	}
//
...
//					.isNetworkAvailable(TestOrderNoBuyActivity.this)) {
